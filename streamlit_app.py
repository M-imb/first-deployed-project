...
user_input = pd.DataFrame([{ # Обратите внимание на ОДНУ квадратную скобку, за которой идет фигурная скобка
    'island': island_input,
    'sex': sex_input,
...
for col in ['bill_length_mm', 'bill_depth_mm', 'flipper_length_mm', 'body_mass_g']:
    user_encoded[col] = user_input[col].values                # порядок столбцов точно совпадает с порядком столбцов, на которых была обучена модель (X_train_encoded)
